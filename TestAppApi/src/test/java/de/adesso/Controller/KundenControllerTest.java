...
public class KundenControllerTest {
	...
	public void test1() throws Exception {
		...
		String sol = mvc
				.perform(MockMvcRequestBuilders.request(HttpMethod.POST, "http://localhost:9000/kunde/createKunde")
						.param("name", newKunde.getName()).param("adresse", newKunde.getAdresse())
						.param("email", newKunde.getEmail()).param("ausweisnr", newKunde.getAusweisnr())
						.param("geschlecht", newKunde.getGeschlecht().name()).param("gebDatum", "30/12/1984"))
	...
	public void test4() throws Exception {
		...
		String sol = mvc
				.perform(MockMvcRequestBuilders.request(HttpMethod.DELETE,
	...
	public void test3() throws Exception {
		ObjectMapper mapper = new ObjectMapper();
		String sol = mvc
				.perform(MockMvcRequestBuilders.request(HttpMethod.GET, "http://localhost:9000/kunde/getKundebyEmail/")
						.param("email", "Dörte@email.de"))
				.andReturn().getResponse().getContentAsString();
