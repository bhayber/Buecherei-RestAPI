...
public class PersonControllerTest {
	...
	public void test4() throws Exception {
		...
		String sol = mvc.perform(
				MockMvcRequestBuilders.request(HttpMethod.DELETE, "http://localhost:9000/person/deletePersonByMail")
						.param("email", "neueEmail@hansseite.de"))
	...
	public void test1() throws Exception {
		...
		String sol = mvc
				.perform(MockMvcRequestBuilders.request(HttpMethod.POST, "http://localhost:9000/person/createPerson")
						.param("name", "Hans").param("email", "hans@hansseite.de"))
				.andReturn().getResponse().getContentAsString();
	...
	//// .andReturn().getResponse().getContentAsString();
	//// List<Person> list = mapper.readValue(personList, new
	...
	public void test3() throws Exception {
		...
		String personJson = mvc
				.perform(get("http://localhost:9000/person/getPersonByEmail").param("email", "neueEmail@hansseite.de"))
	...
	public void test2() throws Exception {
		...
		String personJson = mvc
				.perform(get("http://localhost:9000/person/getPersonByEmail").param("email", "hans@hansseite.de"))
				.andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)).andReturn().getResponse()
				.getContentAsString();
		Person person = mapper.readValue(personJson, Person.class);
		...
		String test = (mvc
				.perform(put("http://localhost:9000/person/updatePerson").param("id", p.getId())
						.param("email", p.getEmail()).param("name", p.getName()).param("geschlecht", "MAENLICH"))
				.andReturn().getResponse().getContentAsString());
